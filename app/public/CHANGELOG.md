...
Bundle of minor UI/usability enhancements.
...
- broken Component Paste Zone layout  ([#2214](https://github.com/adaptlearning/adapt_authoring/issues/2214))
- Error: Unknown transport type console ([#2236](https://github.com/adaptlearning/adapt_authoring/issues/2236))
...
- Super admins should be able to remove any course in the system ([#1922](https://github.com/adaptlearning/adapt_authoring/issues/1922))
...
[0.7.0]: https://github.com/adaptlearning/adapt_authoring/compare/v0.6.4...v0.7.0
